...
# def compute_metrics_for_ner_old(eval_pred, id2label):
#     """
...
from deepmed_ctrain_utils.ner_metric import evaluate_ner_v1
...
def compute_metrics_for_ner(eval_pred, id2label):
    ...
    results = evaluate_ner_v1(preds=true_predictions, golds=true_labels)
